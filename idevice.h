 ...
 * # Arguments
 * * [`provider`] - An IdeviceProvider
 * * [`client`] - On success, will be set to point to a newly allocated MCInstallerClient handle
 *
 * # Returns
 * An IdeviceFfiError on error, null on success
 *
 ...
 *
 * # Arguments
 * * [`client`] - A valid MCInstallerClient handle
 * * [`out_plist`] - On success, will be set to the profile list plist
 *
 * # Returns
 * An IdeviceFfiError on error, null on success
 *
 * # Safety
 * `client` must be a valid pointer to a handle allocated by this library
 * `out_plist` must be a valid pointer to a location where the plist pointer will be stored
 */
 ...
 * # Arguments
 * * [`client`] - A valid MCInstallerClient handle
 * * [`profile_data`] - The configuration profile data to install
 ...
 * # Arguments
 * * [`client`] - A valid MCInstallerClient handle
 * * [`identifier`] - The identifier of the profile to remove (C string)
 *
 * # Returns
 * An IdeviceFfiError on error, null on success
 *
 * # Safety
 * `client` must be a valid pointer to a handle allocated by this library
 * `identifier` must be a valid C string
 */
